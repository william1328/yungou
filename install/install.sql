...
-- ----------------------------
-- Table structure for `_cloud_info_innodb`
-- ----------------------------
DROP TABLE IF EXISTS `####_cloud_info_innodb`;
CREATE TABLE `####_cloud_info_innodb` (
  `oid` int(11) unsigned NOT NULL,
  `ogid` int(11) DEFAULT NULL,
  `ogocode` longtext,
  `oremark` varchar(500) DEFAULT NULL,
  `otext` text COMMENT '订单附加信息',
  KEY `oid` (`oid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单附表的innodb';

-- ----------------------------
-- Table structure for `_cloud_order_innodb`
-- ----------------------------
DROP TABLE IF EXISTS `####_cloud_order_innodb`;
CREATE TABLE `####_cloud_order_innodb` (
  ...
  PRIMARY KEY (`oid`,`ocode`),
  KEY `ogid` (`ogid`),
  KEY `ouid` (`ouid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单表的innodb';

-- ----------------------------
-- TRIGGER  for `_cloud_order_innodb`
-- ----------------------------

DROP TRIGGER IF EXISTS `####_checkuporder`;
CREATE TRIGGER `####_checkuporder` AFTER INSERT ON `####_cloud_order_innodb` FOR EACH ROW BEGIN
	IF (SELECT COUNT(`oid`) FROM `####_cloud_info_innodb`) >='1000' THEN
	DELETE FROM `####_cloud_info_innodb` WHERE 1=1 ORDER BY  oid  LIMIT  500;END IF;END
;

-- ----------------------------
-- TRIGGER  for `_cloud_info_innodb`
-- ----------------------------	
DROP TRIGGER IF EXISTS `####_checkuporderinfo`;
CREATE TRIGGER `####_checkuporderinfo` AFTER INSERT ON `####_cloud_info_innodb` FOR EACH ROW BEGIN
	IF (SELECT COUNT(`oid`) FROM `####_cloud_order_innodb`) >='1000' THEN
	DELETE FROM `####_cloud_order_innodb` WHERE 1=1 ORDER BY  oid  LIMIT  500;END IF;END
;
...
INSERT INTO `####_config` VALUES ('97', 'base', 'sqlsafe', 'on', null);
...
INSERT INTO `####_config` VALUES ('150','fufen', 'fufen_share', '0', '晒单福分奖励');
...
INSERT INTO `####_ments` VALUES ('91', '74', '0', '1', '分组添加', null, 'auth', 'group_add', '', null, null);
INSERT INTO `####_ments` VALUES ('92', '74', '0', '1', '分组修改', null, 'auth', 'group_edit', '', null, null);
INSERT INTO `####_ments` VALUES ('93', '74', '0', '1', '权限分配', null, 'auth', 'group_auth', '', null, null);
INSERT INTO `####_ments` VALUES ('94', '74', '0', '1', '添加管理员', null, 'auth', 'admin_add', '', null, null);
INSERT INTO `####_ments` VALUES ('95', '74', '0', '1', '删除管理员', null, 'auth', 'admin_del', '', null, null);
INSERT INTO `####_ments` VALUES ('96', '74', '0', '1', '功能添加', null, 'auth', 'fun_add', '', null, null);
INSERT INTO `####_ments` VALUES ('97', '74', '0', '1', '功能修改', null, 'auth', 'fun_edit', '', null, null);
INSERT INTO `####_ments` VALUES ('98', '74', '0', '1', '功能删除', null, 'auth', 'fun_del', '', null, null);
INSERT INTO `####_ments` VALUES ('99', '74', '0', '1', '修改管理员', null, 'auth', 'admin_edit', '', null, null);
INSERT INTO `####_ments` VALUES ('100', '1', '0', '1', '清空缓存', null, 'other', 'caches', '', null,null);
INSERT INTO `####_ments` VALUES ('101', '1', '0', '1', '底部搜索', null, 'order', 'search', '', null,null);
INSERT INTO `####_ments` VALUES ('158', '18', '0', '1', '内容图片上传', null, 'ueditor', 'upimage', '', null, null);
INSERT INTO `####_ments` VALUES ('159', '18', '0', '1', '内容图片上传', null, 'ueditor', 'imagemanager', '', null, null);
INSERT INTO `####_ments` VALUES ('102', '18', '0', '1', '修改文章', null, 'article', 'article_edit', '', null, null);
INSERT INTO `####_ments` VALUES ('103', '18', '0', '1', '文章栏目修改', null, 'cate', 'editcate', 'article', null, null);
INSERT INTO `####_ments` VALUES ('104', '18', '0', '1', '栏目添加', null, 'cate', 'addcate', 'article', null, null);
INSERT INTO `####_ments` VALUES ('105', '22', '0', '1', '单页修改', null, 'cate', 'editcate', 'web', null, null);
INSERT INTO `####_ments` VALUES ('106', '30', '0', '1', '添加导航条', null, 'other', 'nav_add', '', null, null);
INSERT INTO `####_ments` VALUES ('107', '30', '0', '1', '添加圈子', null, 'other', 'club_add', '', null, null);
INSERT INTO `####_ments` VALUES ('108', '30', '0', '1', '查看帖子', null, 'other', 'topic', '', null, null);
INSERT INTO `####_ments` VALUES ('109', '30', '0', '0', '查看回复', null, 'other', 'msg', '', null, null);
INSERT INTO `####_ments` VALUES ('110', '30', '0', '1', '修改帖子', null, 'other', 'topic_edit', '', null, null);
INSERT INTO `####_ments` VALUES ('111', '30', '0', '1', '删除帖子', null, 'other', 'topic_del', '', null, null);
INSERT INTO `####_ments` VALUES ('112', '30', '0', '1', '删除回复', null, 'other', 'msg_del', '', null, null);
INSERT INTO `####_ments` VALUES ('113', '30', '0', '1', '修改圈子', null, 'other', 'club_edit', '', null, null);
INSERT INTO `####_ments` VALUES ('114', '30', '0', '1', '删除圈子', null, 'other', 'club_del', 'quanzi', null, null);
INSERT INTO `####_ments` VALUES ('115', '30', '0', '1', '添加链接', null, 'other', 'link_add', '', null, null);
INSERT INTO `####_ments` VALUES ('116', '30', '0', '1', '修改链接', null, 'other', 'link_edit', '', null, null);
INSERT INTO `####_ments` VALUES ('117', '30', '0', '1', '删除链接', null, 'other', 'link_del', '', null, null);
INSERT INTO `####_ments` VALUES ('118', '30', '0', '1', '添加广告位', null, 'other', 'ad_pos_add', '', null, null);
INSERT INTO `####_ments` VALUES ('119', '30', '0', '1', '修改广告位', null, 'other', 'ad_pos_edit', '', null, null);
INSERT INTO `####_ments` VALUES ('120', '30', '0', '1', '删除广告位', null, 'other', 'ad_pos_del', '', null, null);
INSERT INTO `####_ments` VALUES ('121', '30', '0', '1', '广告管理', null, 'other', 'ad', '', null, null);
INSERT INTO `####_ments` VALUES ('122', '30', '0', '1', '广告添加', null, 'other', 'ad_add', '', null, null);
INSERT INTO `####_ments` VALUES ('123', '30', '0', '1', '广告修改', null, 'other', 'ad_edit', '', null, null);
INSERT INTO `####_ments` VALUES ('124', '30', '0', '1', '广告删除', null, 'other', 'ad_del', '', null, null);
INSERT INTO `####_ments` VALUES ('125', '34', '0', '1', '详情图片上传', null, 'ueditor', 'upimage', '', null, null);
INSERT INTO `####_ments` VALUES ('126', '34', '0', '0', '详情图片上传', null, 'ueditor', 'imagemanager', '', null, null);
INSERT INTO `####_ments` VALUES ('127', '41', '0', '1', '详情图片上传', null, 'ueditor', 'upimage', '', null, null);
INSERT INTO `####_ments` VALUES ('128', '41', '0', '1', '详情图片上传', null, 'ueditor', 'imagemanager', '', null, null);
INSERT INTO `####_ments` VALUES ('129', '34', '0', '1', '商品修改', null, 'goods', 'goods_edit', '', null, null);
INSERT INTO `####_ments` VALUES ('130', '34', '0', '1', '商品删除', null, 'goods', 'goods_del', '', null, null);
INSERT INTO `####_ments` VALUES ('131', '34', '0', '1', '商品栏目添加', null, 'cate', 'addcate', 'goods', null, null);
INSERT INTO `####_ments` VALUES ('132', '34', '0', '1', '商品栏目修改', null, 'cate', 'editcate', 'goods', null, null);
INSERT INTO `####_ments` VALUES ('133', '34', '0', '1', '商品栏目删除', null, 'cate', 'delcate', 'goods', null, null);
INSERT INTO `####_ments` VALUES ('134', '34', '0', '1', '品牌修改', null, 'goods', 'brand_edit', '', null, null);
INSERT INTO `####_ments` VALUES ('135', '34', '0', '1', '品牌删除', null, 'goods', 'brand_del', '', null, null);
INSERT INTO `####_ments` VALUES ('136', '34', '0', '1', '设为人气/推荐', null, 'goods', 'goods_set', '', null, null);
INSERT INTO `####_ments` VALUES ('137', '41', '0', '1', '重置价格', null, 'goods', 'goods_set_money', '', null, null);
INSERT INTO `####_ments` VALUES ('138', '41', '0', '1', '修改商品', null, 'goods', 'cloud_goods_edit', '', null, null);
INSERT INTO `####_ments` VALUES ('139', '41', '0', '1', '查看往期', null, 'goods', 'qishu_list', '', null, null);
INSERT INTO `####_ments` VALUES ('140', '41', '0', '1', '删除商品', null, 'goods', 'cloud_goods_dels', '', null, null);
INSERT INTO `####_ments` VALUES ('141', '41', '0', '1', '购买详情', null, 'goods', 'goods_go_one', '', null, null);
INSERT INTO `####_ments` VALUES ('142', '41', '0', '0', '删除商品', null, 'goods', 'cloud_goods_del', '', null, null);
INSERT INTO `####_ments` VALUES ('143', '43', '0', '1', '订单跟踪', null, 'order', 'genzhong', '', null, null);
INSERT INTO `####_ments` VALUES ('144', '43', '0', '1', '订单详情', null, 'order', 'detail', '', null, null);
INSERT INTO `####_ments` VALUES ('145', '43', '0', '1', '晒单回复', null, 'order', 'share_msg', '', null, null);
INSERT INTO `####_ments` VALUES ('146', '52', '0', '1', '会员修改', null, 'member', 'modify', '', null, null);
INSERT INTO `####_ments` VALUES ('147', '52', '0', '1', '会员删除', null, 'member', 'del', '', null, null);
INSERT INTO `####_ments` VALUES ('148', '52', '0', '1', '会员配置', null, 'member', 'member_fufen', '', null, null);
INSERT INTO `####_ments` VALUES ('149', '61', '0', '1', '修改导航条', null, 'other', 'nav_edit', '', null, null);
INSERT INTO `####_ments` VALUES ('150', '61', '0', '1', '修改导航条', null, 'other', 'nav_del', '', null, null);
INSERT INTO `####_ments` VALUES ('151', '61', '0', '1', '修改幻灯', null, 'other', 'slide_update', '', null, null);
INSERT INTO `####_ments` VALUES ('152', '61', '0', '1', '删除幻灯', null, 'other', 'slide_del', '', null, null);
INSERT INTO `####_ments` VALUES ('153', '61', '0', '1', '添加幻灯', null, 'other', 'slide_add', '', null, null);
INSERT INTO `####_ments` VALUES ('154', '65', '0', '1', '修改标签', null, 'htmlcustom', 'edit', '', null, null);
INSERT INTO `####_ments` VALUES ('155', '65', '0', '1', '删除标签', null, 'htmlcustom', 'del', '', null, null);
INSERT INTO `####_ments` VALUES ('156', '65', '0', '1', '添加标签', null, 'htmlcustom', 'create', '', null, null);
INSERT INTO `####_ments` VALUES ('157', '65', '0', '1', '修改模板', null, 'other', 'template_edit', '', null, null);
...
INSERT INTO `####_payment` VALUES ('12', '手机支付宝', 'malipay', '1', 'photo/20150420/zfbpay.jpg', '0', null, null, null,'2');
INSERT INTO `####_payment` VALUES ('13', '聚宝支付', 'jubaopay', '1', 'photo/20150420/jubaopay.png', '0', null, null, null,'1,2');
...
CREATE TABLE `####_user_money_record` (
  ...
  `pay_type` char(10) DEFAULT '0' COMMENT '支付方式',
  `score` int(10) DEFAULT '0' COMMENT '福分',  
  PRIMARY KEY (`id`)
...
CREATE TABLE `####_user_recodes` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户id',
  `r_uid` int(10) unsigned NOT NULL COMMENT '邀请人id',
...
-- ----------------------------
-- Records of go_user_recodes
-- ----------------------------

-- ----------------------------
-- Table structure for _weixin
-- ----------------------------
DROP TABLE IF EXISTS `####_weixin`;
CREATE TABLE `####_weixin` (
  `id` int(11) NOT NULL auto_increment,
