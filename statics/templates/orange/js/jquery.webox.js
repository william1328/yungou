		...
		if(jwebox_shopid&&jwebox_shopid==shopid&&jwebox.DOMS['goshopnow']){		 
			...
			var html = jwebox.heredoc(function(){/*	
				...
				*{margin:0;padding:0;list-style-type:none;}
				...
				.jwebox_shop_buttom{width:200px;margin:0px 10px;}
				...
				color: #fff;font-size: 14px;border-radius: 3px;display:block;}
				.jwebox_Det_Shopnow:hover{color:#fff;background:#f60;}
				</style>
				<div class="jwebox_showbox">			
					<div class="jwebox_background"></div>
						...
						<h1 class="jwebox_locked"  onselectstart="return false;">快捷支付——您将要购买的商品信息<a class="span" href="javascript:void(0);">×</a></h1>				
							...
							<div class="jwebox_mainlist"><span>共计：<span class="jwebox_sum" ></span>金币</span></div>	
							<div class="jwebox_mainlist">您的账户<span class="jwebox_mainlist_uspecies">余额：<span class="jwebox_uspecies" ></span>金币</span></div>	
