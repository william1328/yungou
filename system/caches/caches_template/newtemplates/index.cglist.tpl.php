			...
			<li class="list-block">
				...
				<div class="w-goods-ing">
					<div class="shop_buttom bg_red b_red1" style="margin:0 10px;width:115px;height:30px;">
						<a href="javascript:;" style="line-height:30px;font-size:14px;"  class="Det_Shopnow" onclick="jwebox.goshopnow(<?php echo $shop['id']; ?>,'<?php echo WEB_PATH; ?>')"><?php echo L('cgoods.go'); ?></a>
					</div>
