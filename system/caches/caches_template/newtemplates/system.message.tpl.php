...
<div class="box">
	<div class="box-b">
        ...
        <div class="box-button"><a class="a-2" href="javascript:;" onclick="locahost()"> <font id="time" style="color:red;"><?php echo $time; ?></font> 秒后返回上一页面</a>
        	<a class="a-1" href="javascript:;" onclick="locahome()">首页</a></div> 
