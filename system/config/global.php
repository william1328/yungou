...
if(System::load_sys_config('system','gzip') && function_exists('ob_gzhandler')) {if(stripos($_SERVER['HTTP_USER_AGENT'],'flash') === FALSE){ob_start('_ob_gzhandler');}else{ob_start();}} else {ob_start();}
