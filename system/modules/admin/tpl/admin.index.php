...
<div rel="all">
    <div class="" rel="top">
        <div class="lf" rel="left">
            <div class="header">
                <div class="lf"><p><img src="<?php echo G_GLOBAL_STYLE; ?>/global/image/YunGouCMS_logo_white.png" width="130"></p><p>云购管理系统</p></div>
            </div>
            <div class="menu">
                <ul>
                    <li class="me_mm">
    ...
    <div class="" rel="bottom">
        <div class="footer">
            <div class="lf btn_list cir_a">
                ...
                <div class="lf btn" onClick="btn_gongdan();">提交工单</div>
                <div class="cl"></div>
            </div>
