...
<form name="myform" action="" method="post" enctype="multipart/form-data">
  <table width="100%" cellspacing="0">
  	 <tr>
			...
			<td>
				<input type="text" name="f_overziliao" value="<?php echo $config['f_overziliao'];?>" class="input-text">(<?php echo L('cgoods.credit');?>)&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			...
			<td>
				<input type="text" name="f_shoppay" value="<?php echo $config['f_shoppay'];?>" class="input-text">(<?php echo L('cgoods.credit');?>)&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			...
			<td>
				<input type="text" name="f_phonecode" value="<?php echo $config['f_phonecode'];?>" class="input-text">(<?php echo L('cgoods.credit');?>)&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			...
			<td>
				<input type="text" name="f_visituser" value="<?php echo $config['f_visituser'];?>" class="input-text">(<?php echo L('cgoods.credit');?>)&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			...
			<td>
				<input type="text" name="fufen_yuan" value="<?php echo $config['fufen_yuan'];?>" class="input-text">(<?php echo L('cgoods.credit');?>/元)&nbsp;&nbsp;&nbsp;&nbsp;备注：<?php echo L('cgoods.credit');?>请输入10的整数
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="fufen_share" maxlength="4" value="<?php echo $config['fufen_share'];?>" class="input-text">&nbsp;&nbsp;&nbsp;&nbsp;备注：（新增）晒单一次奖励<?php echo L('cgoods.credit');?>！
			</td>
		</tr>		
		<!--
		<tr>
			...
			<td>-->
				<input type="hidden" name="fufen_yongjintx" onkeyup="value=value.replace(/\D/g,'')"  value="<?php echo $config['fufen_yongjintx'];?>" class="input-text">&nbsp;&nbsp;&nbsp;&nbsp;备注：提现一百元佣金所产生的手续费
		<!--	</td>
		</tr>
		-->
		<tr>
